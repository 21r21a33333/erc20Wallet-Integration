// components/TransferFromComponent.tsx
"use client";
...
export function TransferFromComponent({
  onMintConfirmed,
}: {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const from = formData.get("from") as string; // Address to transfer tokens from
    const to = formData.get("to") as string; // Address to transfer tokens to
    const amountString = formData.get("amount") as string; // Amount of tokens to transfer

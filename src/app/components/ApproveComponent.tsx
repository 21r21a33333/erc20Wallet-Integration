// components/ApproveComponent.tsx
"use client";
...
export function ApproveComponent({
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const spender = formData.get("spender") as string; // Address to approve for spending
    const amountString = formData.get("amount") as string; // Amount of tokens to approve
